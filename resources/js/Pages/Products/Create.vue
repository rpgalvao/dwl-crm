...
// A mesma máscara de dinheiro que usamos nas negociações!
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        >
                            ...
                            <button
                                ...
                                class="bg-dwl-teal text-white px-6 py-2.5 rounded-md hover:bg-dwl-darkblue font-semibold disabled:opacity-50 transition-colors"
                            >
                                Salvar Reagente
                            </button>
                        </div>
